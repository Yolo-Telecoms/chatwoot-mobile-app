...
export const ChannelIndicator = (props: ChannelIndicatorProps) => {
  ...
  return (
    <NativeView style={tailwind.style('pl-1 gap-1 flex flex-row justify-center items-center')}>
      <Icon icon={getChannelIcon(channelType as Channel, medium, type)} size={16} />
      <Text style={tailwind.style('text-sm font-inter-420-20 text-gray-700')}>Facebook</Text>
    </NativeView>
  );
};
